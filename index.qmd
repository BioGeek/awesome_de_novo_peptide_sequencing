...
Palaeoproteomics flow looks thin because Crossref's reference-list coverage for older Nature papers is patchy, and much of the palaeo bibliography (palaeogenetics, anthropology, palaeontology) is off-catalog. What survives (edges to PEAKS DB and PEAKS) is genuine but under-represents actual tool use.
