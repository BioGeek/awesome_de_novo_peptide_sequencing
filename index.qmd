  ...
  const chart = Plot.plot({
    ...
    marks: [
      ...
      Plot.dot(items, {
        ...
        stroke: "white",
        strokeWidth: 1.5,
        // Tooltip sized to match the .map-tooltip on the world map (12-13px,
        // roomier padding, white background with a soft border).
        tip: {
          fontSize: 13,
          lineHeight: 1.35,
          textPadding: 10,
  ...
  const chart = Plot.plot({
    ...
    marks: [
      ...
      Plot.dot(items, {
        ...
        // Tooltip sized to match the .map-tooltip on the world map.
        tip: {
          fontSize: 13,
          lineHeight: 1.35,
          textPadding: 10,
