...
The earliest paper tracked here appeared in **${first_year}**; the first deep-learning method shows up in **${first_dl_year}**. Activity has accelerated sharply since — most published work is still preprints, reflecting how fast this field moves.
