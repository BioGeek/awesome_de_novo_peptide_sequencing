...
# architectures swim lane drops any family outside its 13 hand-tuned bands
# (visible_bands = band_order.filter(...)), which silently hides 36 of the 49
# families and 76 of the 192 methods that carry one. Ten of the hidden families
# first appeared before 2005, so the classical era is invisible on both charts.
