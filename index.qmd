...
::: {.global-filters}
**Filters** — apply to *The wave*, *The architectures*, top authors, top venues, and Browse-all. Reset by re-checking all boxes / picking *all*.
:::
...
```{=html}
<style>
.global-filters { padding: 0.5rem 1rem; background: #f0f6ff; border-left: 4px solid #1f6feb; border-radius: 0 0.25rem 0.25rem 0; margin: 1rem 0 0.5rem; font-size: 0.92rem; color: #24292f; }
</style>
```
