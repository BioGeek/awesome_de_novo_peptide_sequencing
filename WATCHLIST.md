...
Every one of the 287 `algorithm` rows has at least one linked publication, because
...
- **"Bioactive Peptides from Common Beans: A Review"** (MDPI *Nutraceuticals*
  ...
  implicit in the rows themselves. **All 27 existing review entries have de novo
